...
const Login = () => {
  return (
    <div class="w-full h-screen flex justify-center items-center bg-green-100">
      <div className="login-content page-card bg-white rounded-lg shadow-lg p-6">
        <div className="page-card-head text-center mb-6">
          <img
            className="app-logo max-w-xs mx-auto"
            src={process.env.LOGO_MAIN}
          />
          <h4 className="text-lg font-semibold mt-5">
            Login to Robin Hood Army
          </h4>
        </div>
        <form className="form-signin form-login flex flex-col" role="form">
          <div className="page-card-body mb-6">
            <div className="form-group mb-4">
              ...
              <div className="email-field relative">
                ...
                />
                <svg
                  className="field-icon email-icon absolute right-2 top-1/2 transform -translate-y-1/2"
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
                  fill="none"
            ...
            <div className="form-group mb-4">
              ...
              <div className="password-field relative">
                ...
                />
                <svg
                  className="field-icon password-icon absolute right-2 top-1/2 transform -translate-y-1/2"
                  width={20}
                  height={20}
                  viewBox="0 0 20 20"
                  fill="none"
